...
list_sigv <- list(0, 3, 6, 12)


for(sig_v in list_sigv){
  ...
  saveRDS(Xs, paste0('Xs_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(real_betas, paste0('real_betas_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(Zs, paste0('Zs_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(yss, paste0('yss_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
...
for(sig_v in list_sigv){
  ...
  Xs <- readRDS(paste0('Xs_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  real_betas <- readRDS(paste0('real_betas_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  Zs <- readRDS(paste0('Zs_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  yss <- readRDS(paste0('yss_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  saveRDS(cAIC_model_setss, paste0('cAIC_model_setss_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
...
for(setting in list_settings){
  ...
  for(jj in 1:sim_num){
    ...
    for(j in 1:its){
      ...
      sel_vec <- rep(Inf, length(lambda_vec))
      ...
      for (l in 1:length(lambda_vec)) {
        ...
        if (!inherits(glm3, "try-error")) {
          sel_vec[l] <- sum(glm3$coefficients!=0)
          BIC_vec[l] <- glm3$bic
      ...
      #inference_tot_dat <- dat[,c('y','subjind', selected_tot_names)]
  ...
  saveRDS(naive_pvals_df, file = paste0('naive_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(naive_results_df, file = paste0('naive_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  saveRDS(datasplitting_pvals_df, file = paste0('datasplitting_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(datasplitting_results_df, file = paste0('datasplitting_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  saveRDS(pvals_df, file = paste0('postcAIC_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(results_df, file = paste0('postcAIC_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  selFun <- function(yy){
    ...
    PQL<-try(glmmPQL(y~-1,random = ~1|subjind, family='gaussian', control = lmeControl(opt = "optim"),data=dat,verbose='FALSE'), silent = TRUE)
  ...
  saveRDS(selfmadelasso_pvals_df, file = paste0('selfmadelasso_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(selfmadelasso_results_df, file = paste0('selfmadelasso_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  saveRDS(pvals_df, file = paste0('selfmadestep_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(results_df, file = paste0('selfmadestep_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  ...
  saveRDS(UVILassoLMM_pvals_df, file = paste0('UVILassoLMM_pvals_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))
  saveRDS(UVILassoLMM_results_df, file = paste0('UVILassoLMM_results_n',n,'_p',p,'_p_rel',p_rel,'_q',q,'_sigv',sig_v,'.RDS'))

...
for(jj in 1:sim_num){
  ...
  # glm3_final <- try(glmmLasso(fix = y ~ -1 + sex + age + year + X1 + X2 + X3 + X4 + X5, rnd = list(subjind=~1), data = dat, lambda=lambda_vec[opt3], switch.NR=FALSE,final.re=FALSE,
  #                             control=list(center=FALSE, start=Delta.start[opt3,], q_start = Q.start[opt3], standardize=FALSE)), silent=TRUE)
...
saveRDS(naive_pvals_df, file = paste0('framingham_naive_pvals_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC.RDS'))
saveRDS(naive_results_df, file = paste0('framingham_naive_results_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC.RDS'))
...
for(jj in 1:sim_num){
  ...
  # glm3_final <- try(glmmLasso(fix = y ~ -1 + sex + age + year + X1 + X2 + X3 + X4 + X5, rnd = list(subjind=~1), data = selection_dat, lambda=lambda_vec[opt3], switch.NR=FALSE,final.re=FALSE,
  #                             control=list(start=Delta.start[opt3,],q_start=Q.start[opt3], center=FALSE, standardize=FALSE)), silent=TRUE)
  # 
...
# 
saveRDS(datasplitting_pvals_df, file = paste0('framingham_datasplitting_pvals_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC.RDS'))
saveRDS(datasplitting_results_df, file = paste0('framingham_datasplitting_results_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC.RDS'))
...
saveRDS(pvals_df, file = paste0('framingham_postcAIC_pvals_pnoise',pnoise,'_SNR',SNR,'_scaleyear.RDS'))
saveRDS(results_df, file = paste0('framingham_postcAIC_results_pnoise',pnoise,'_SNR',SNR,'_scaleyear.RDS'))
...
saveRDS(selfmadelasso_pvals_df, file = paste0('framingham_selfmadelasso_pvals_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC',itnum,'.RDS'))
saveRDS(selfmadelasso_results_df, file = paste0('framingham_selfmadelasso_results_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_glmmlasso_BIC',itnum,'.RDS'))
...
saveRDS(pvals_df, file = paste0('framingham_selfmadestep_pvals_pnoise',pnoise,'_SNR',SNR,'_scaleyear.RDS'))
saveRDS(results_df, file = paste0('framingham_selfmadestep_results_pnoise',pnoise,'_SNR',SNR,'_scaleyear.RDS'))
...
for(jj in 1:sim_num){
  ...
  #beta <- glmnet(x = V_menunmezz%*%X, y = V_menunmezz%*%y, lambda=lambda/n, intercept = FALSE)$beta
...
saveRDS(UVILassoLMM_pvals_df, file = paste0('framingham_UVILassoLMM_pvals_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_standardFALSE.RDS'))
saveRDS(UVILassoLMM_results_df, file = paste0('framingham_UVILassoLMM_results_framingham_pnoise',pnoise,'_SNR',SNR,'_scaleyear_standardFALSE.RDS'))
